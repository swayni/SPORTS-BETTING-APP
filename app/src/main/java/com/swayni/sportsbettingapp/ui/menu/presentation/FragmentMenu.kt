package com.swayni.sportsbettingapp.ui.menu.presentation
...
import com.swayni.sportsbettingapp.ui.menu.adapter.SportLeagueAdapter
import com.swayni.sportsbettingapp.ui.menu.viewmodel.SportLeagueViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class FragmentMenu : BaseFragment<FragmentMenuBinding, SportLeagueViewModel>(
    ...
    private fun  onItemClick(sportKey : String){
        viewModel.navigate(FragmentMenuDirections.actionFragmentMenuToFragmentBulletin(sportKey))
    }
}