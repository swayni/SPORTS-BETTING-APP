...
class UpdateOddUseCase @Inject constructor(private val repository: IRepository) : BaseUseCase() {

    suspend fun execute(selectedModel: SelectedModel):Flow<ResultData<Boolean>> = invoke { repository.updateOdd(selectedModel) }
}